...
# TestNode: A peer we use to send messages to giracoind, and store responses.
...
class CompactBlocksTest(GiracoinTestFramework):
    def __init__(self):
        super().__init__()
    ...
    # This test actually causes giracoind to (reasonably!) disconnect us, so do this last.
    ...
    # Test that giracoind requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for giracoind to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # giracoind won't respond for blocks whose height is more than 15 blocks
        # deep.
