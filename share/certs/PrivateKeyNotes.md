...
unlocked to sign the Giracoin-Qt.app bundle.
...
allowing somebody to distribute a Giracoin-Qt.app or giracoin-qt-setup.exe with a valid
...
that the giracoin-qt.exe file inside the installer had not been tampered with.
