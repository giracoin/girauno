...
#ifndef GIRACOIN_QT_GIRACOINUNITS_H
#define GIRACOIN_QT_GIRACOINUNITS_H
...
/** Giracoin unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class GiracoinUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit GiracoinUnits(QObject *parent);

    /** Giracoin units.
      @note Source: https://en.giracoin.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        GRC,
...
typedef GiracoinUnits::Unit GiracoinUnit;

#endif // GIRACOIN_QT_GIRACOINUNITS_H
