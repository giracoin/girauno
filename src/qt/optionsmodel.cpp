...
void OptionsModel::Init(bool resetSettings)
{
    ...
    if (!settings.contains("nDisplayUnit"))
        settings.setValue("nDisplayUnit", GiracoinUnits::GRC);
    ...
    QVariant qnReserveBalance = QVariant::fromValue(nReserveBalance);
    if (!settings.contains("nReserveBalance"))
        settings.setValue("nReserveBalance", qnReserveBalance);
    qnReserveBalance = QVariant::fromValue(settings.value("nReserveBalance"));
    if (!SoftSetBoolArg("-reservebalance", qnReserveBalance > 0))
...
bool OptionsModel::setData(const QModelIndex & index, const QVariant & value, int role)
{
    ...
    if(role == Qt::EditRole)
    {
        ...
        case SpendZeroConfChange:
            ...
            break;
        case ReserveBalance:
            if (settings.value("nReserveBalance") != value.toLongLong()) {
...
void OptionsModel::checkAndMigrate()
{
    ...
    if (settingsVersion < CLIENT_VERSION)
    {
        ...
        // see https://github.com/giracoin/giracoin/pull/8273
