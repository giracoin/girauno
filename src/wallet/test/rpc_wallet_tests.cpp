// Copyright (c) 2013-2015 The Giracoin Core developers
...
BOOST_AUTO_TEST_CASE(rpc_wallet)
{
    ...
    UniValue r;
    CPubKey demoPubkey;
    CGiracoinAddress demoAddress;
    UniValue retValue;
    string strAccount = "walletDemoAccount";
    CGiracoinAddress setaccountDemoAddress;
    {
        LOCK(pwalletMain->cs_wallet);

        demoPubkey = pwalletMain->GenerateNewKey();
        demoAddress = CGiracoinAddress(CTxDestination(demoPubkey.GetID()));
        ...
        setaccountDemoAddress = CGiracoinAddress(CTxDestination(setaccountDemoPubkey.GetID()));
    }
    /*********************************
     * 			setaccount
     *********************************/
    ...
    BOOST_CHECK(CGiracoinAddress(retValue.get_str()).Get() == demoAddress.Get());
    ...
    BOOST_CHECK(CGiracoinAddress(arr[0].get_str()).Get() == demoAddress.Get());
