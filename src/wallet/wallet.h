...
#ifndef GIRACOIN_WALLET_WALLET_H
#define GIRACOIN_WALLET_WALLET_H
...
public:
    ...
    inline void SerializationOp(Stream& s, Operation ser_action, int nType, int nVersion) {
        ...
        if (!ser_action.ForRead())
        {
            ...
            /** [PoS implementation] - vfSpent logic
            std::string str;
        ...
        if (ser_action.ForRead())
        {
            ...
            if (mapValue.count("spent"))
                BOOST_FOREACH(char c, mapValue["spent"])
    ...
    /**
     * [PoS implementation] marks certain txout's as spent
...
public:
    ...
    bool CreateCoinStake(const CKeyStore& keystore, unsigned int nBits, int64_t nFees, CMutableTransaction& txNew, CKey& key, const int64_t blockTime,
...
#endif // GIRACOIN_WALLET_WALLET_H
