...
BOOST_AUTO_TEST_CASE(rpc_wallet)
{
    ...
    CGiracoinAddress demoAddress = CGiracoinAddress(CTxDestination(demoPubkey.GetID()));
    Value retValue;
    ...
    CGiracoinAddress setaccountDemoAddress = CGiracoinAddress(CTxDestination(setaccountDemoPubkey.GetID()));
