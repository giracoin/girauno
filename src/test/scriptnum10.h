...
#ifndef GIRACOIN_TEST_SCRIPTNUM10_H
#define GIRACOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Giracoin Core 0.10.0, for cross-comparison.
 */
public:
