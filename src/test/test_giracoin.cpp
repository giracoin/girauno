...
#define BOOST_TEST_MODULE Giracoin Test Suite

#include "test_giracoin.h"
...
TestingSetup::TestingSetup(const std::string& chainName) : BasicTestingSetup(chainName)
{
    const CChainParams& chainparams = Params();
        ...
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_giracoin_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
