 ...
 */
#ifndef GIRACOIN_UTIL_H
#define GIRACOIN_UTIL_H
...
extern const char * const GIRACOIN_CONF_FILENAME;
extern const char * const GIRACOIN_PID_FILENAME;
...
{
    std::string s = strprintf("giracoin-%s", name);
