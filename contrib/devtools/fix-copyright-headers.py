...
// Copyright (c) 2009-2012 The Giracoin Core developers
...
CMD_REGEX= "perl -pi -e 's/(20\d\d)(?:-20\d\d)? The Giracoin/$1-%s The Giracoin/' %s"
REGEX_CURRENT= re.compile("%s The Giracoin" % year)
